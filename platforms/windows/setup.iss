...
DefaultDirName=${ISS_INSTALL_DIR}/${APPLICATION_DISPLAY_NAME}
...
[Files]
Source: ${CMAKE_BINARY_DIR}/Release/${APPLICATION_NAME}.exe; DestDir: {app}; Flags: ignoreversion recursesubdirs createallsubdirs
