...
// does some clever extrapolation to increase the accuracy. It is much more accurate than standard finite
...
{
    diff_ridders(function, origin, stepsize, 1.4, 2.0, 15)
}
    ...
    where F: FnMut(&DVector<f64>) -> DVector<f64>
{
    ...
    (DMatrix::from_columns(&columns), max_error)
}
