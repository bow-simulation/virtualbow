...
impl ProfileCurve {
    ...
    fn create_curve(segment: &ProfileSegment, start: [f64; 3]) -> Box<dyn PlanarCurve> {
        match segment {
            ...
            ProfileSegment::Spiral(input) => Box::new(ClothoidSegment::spiral(start, input)),
            ProfileSegment::Spline(input) => Box::new(SplineSegment::new(start, input)),
        }
    }
...
mod tests {
    ...
    fn test_profile_curve() {
        ...
        // TODO: Once the new solver evolves on its own, this test can be removed or modified.
        ...
        let input = vec![
            ProfileSegment::Line(Line::new(0.2)),
            ProfileSegment::Arc(Arc::new(0.2, -0.5)),
            ProfileSegment::Spiral(Spiral::new(0.2, 0.25, 0.5)),
