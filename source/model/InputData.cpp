...
void InputData::load(const QString& path)
{
    ...
    profile_x0 = obj["profile"]["offset_x"].get<double>();
    profile_y0 = obj["profile"]["offset_y"].get<double>();
    profile_phi0 = obj["profile"]["angle"].get<double>();
    sections_width = obj["sections"]["width"].get<Series>();
    sections_height = obj["sections"]["height"].get<Series>();
    sections_rho = obj["sections"]["rho"].get<double>();
    sections_E = obj["sections"]["E"].get<double>();
