...
QMenu* TreeDock::createSegmentMenu() {
    ...
    menu->addAction(QIcon(":/icons/segment-arc.svg"), "New Arc", this, [=]{ add_segment_at_item(ArcInput{{ArcConstraint::LENGTH, 0.2}, {ArcConstraint::K_START, 0.0}}); });
    menu->addAction(QIcon(":/icons/segment-spiral.svg"), "New Spiral", this, [=]{ add_segment_at_item(SpiralInput({{SpiralConstraint::LENGTH, 0.2}, {SpiralConstraint::K_START, 0.0}, {SpiralConstraint::K_END, 0.0}})); });
