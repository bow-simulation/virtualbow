    ...
    : QTableWidget(rows, 2)
{
    ...
    auto action_cut = new QAction(QIcon::fromTheme("edit-cut", QIcon(":icons/edit-cut.png")), "&Cut", this);
    ...
    auto action_copy = new QAction(QIcon::fromTheme("edit-copy", QIcon(":icons/edit-copy.png")), "Cop&y", this);
    ...
    auto action_paste = new QAction(QIcon::fromTheme("edit-paste", QIcon(":icons/edit-paste.png")), "&Paste", this);
    ...
    auto action_delete = new QAction(QIcon::fromTheme("edit-delete", QIcon(":icons/edit-delete.png")), "&Delete", this);
