...
<ul>
  ...
  <br>
  <li><b>Factor = 100%:</b> The bow stores exactly as much energy as a linear draw curve would. Values in this range are common for longbows and similar designs.</li>
  <br>
...
**Power stroke:** The power stroke is the distance from brace height to full draw.
...
It is the ratio between the drawing work put into the bow and the final kinetic energy of the arrow.
...
The categories are **kinetic** and **elastic** energy remaining in the limb and string after the arrow left the string, as well as energy lost to **damping** up to that moment.
