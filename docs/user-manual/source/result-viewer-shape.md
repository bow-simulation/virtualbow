...
The shape view displays the geometry of the limbs and string, along with the arrow's position, at different stages of the draw (for statics) or throughout the show (for dynamics).
