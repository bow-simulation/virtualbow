...
The result viewer opens automatically after a simulation and provides tools to explore the static and dynamic behavior of the bow.
The buttons in the lower-right corner let you switch between static and dynamic results, if available.
All results are organized into tabs, which are described in the following sections.

<figure style="--img-width: 90%">

![Screenshot of the result viewer](images/screenshots/viewer/result-viewer.png)
