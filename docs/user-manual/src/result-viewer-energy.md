...
This plot shows how the energy stored in the bow evolves during the simulation and how it is distributed among components (limbs, string, arrow) and energy types (elastic/potential, kinetic, damping losses).
...
![Screenshot of the energy tab for static results](images/screenshots/viewer/energy-statics.png)
...
![Screenshot of the energy tab for dynamic results](images/screenshots/viewer/energy-dynamics.png)
