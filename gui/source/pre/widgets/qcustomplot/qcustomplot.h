...
public:
  ...
  */
    ...
    void setData(const T1 &keys, const T2 &values, bool alreadySorted=false)
    {
...
public:
  ...
  */
    ...
    void setData(const T1 &t, const T2 &keys, const T3 &values, bool alreadySorted=false)
    {
        mDataContainer->clear();
    ...
    template<class T1, class T2>
    void setData(const T1 &keys, const T2 &values)
    {
        mDataContainer->clear();
        addData(keys, values);
    }
    ...
    // non-property methods:
    template<class T1, class T2, class T3>
    void addData(const T1 &t, const T2 &keys, const T3 &values, bool alreadySorted=false)
    {
    ...
    template<class T1, class T2>
    void addData(const T1 &keys, const T2 &values)
    {
        if (keys.size() != values.size())
            qDebug() << Q_FUNC_INFO << "keys and values have different sizes:" << keys.size() << values.size();
        const int n = qMin(keys.size(), values.size());
