...
%
\begin{align}
x(t) &= c_{x0} + c_{x1}\,t + c_{x2}\,t^2 + c_{x3}\,t^3, \\
y(t) &= c_{y0} + c_{y1}\,t + c_{y2}\,t^2 + c_{y3}\,t^3,
\end{align}
...
%
\begin{align}
x'(t) &= c_{x1} + 2\,c_{x2}\,t + 3\,c_{x3}\,t^2,\\
y'(t) &= c_{y1} + 2\,c_{y2}\,t + 3\,c_{y3}\,t^2, \\
\notag \\
x''(t) &= 2\,c_{x2} + 6\,c_{x3}\,t, \\
y''(t) &= 2\,c_{y2} + 6\,c_{y3}\,t.
\end{align}
...
\textcolor{red}{Todo: Parameterization by arc length (rectification)}
