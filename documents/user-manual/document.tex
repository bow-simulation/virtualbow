...
\usepackage{titlesec}    % Decrease spacing around section titles, https://tex.stackexchange.com/a/53341
...
% Code listings
% https://tex.stackexchange.com/a/99476
...
\quad  arrow\_clamp\_force & \texttt{double} & \unit[]{N} & Arrow clamp force \\
...
\begin{table}[H]
\resizebox{32em}{!}{\begin{tabular}{ l | l | l | l }
\textbf{Field} & \textbf{Type} & \textbf{Unit} & \textbf{Description} \\
\hline
\tablespace setup & & & \\
